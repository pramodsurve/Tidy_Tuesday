...
+ I have used the usmap library to create us map. However there are many more popular libraries to ceate US maps as noted in the reference section.

  + It is important to create county_ids by name fips or state codes by name state if you want to plot by state or counties.

+ The patchwork library requires **&** instead of **+** to specify the theme to put the legend in the correct position. 
